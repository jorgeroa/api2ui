...
| HeroRenderer | src/components/renderers/HeroRenderer.tsx | Profile/hero layout | ✓ Exists (v0.1) |
| TabsRenderer | src/components/renderers/TabsRenderer.tsx | Tabbed sections | ✓ Exists (v0.1) |
| SplitRenderer | src/components/renderers/SplitRenderer.tsx | Content + metadata | ✓ Exists (v0.1) |
| PrimitiveListRenderer | src/components/renderers/PrimitiveListRenderer.tsx | Default primitive array | ✓ Exists |
| ChipsRenderer | src/components/renderers/ChipsRenderer.tsx | Colored tag chips | ✓ Exists (v0.1) |
...
function selectObjectComponent(
  ...
  // Fallback to detail (current v0.2 behavior)
...
function selectPrimitiveArrayComponent(
  ...
  // Fallback to primitive-list (current v0.2 behavior)
