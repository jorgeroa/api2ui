...
9. SemanticPattern interface:
   ...
   - thresholds: { high: number; medium: number } (default: 0.90, 0.75)
...
User threshold is 75% (medium confidence), not 90% - this is the smart default threshold per CONTEXT.md.
  </action>
  <verify>
...
3. Algorithm:
   ...
   - Determine level based on thresholds (high >= 0.90, medium >= 0.75, low > 0)
